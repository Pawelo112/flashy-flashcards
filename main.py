...
correct_button = Button(image=correct_image, highlightthickness=0, compound='center', bd=0, command=generate_card)
correct_button.grid(row=1, column=2)

flip_image = PhotoImage(file='images/flip.png')
flip_button = Button(image=flip_image, background=BACKGROUND_COLOR, highlightthickness=0, compound='center', bd=0,  command=flip_card)
